    ...
    public routes(app:any): void {
        ...
        app.route('/create')
            .post((req: Request, res: Response) => {
                console.log(req.body)   
                 Connection.contract.submitTransaction('CreateAsset', req.body.ID,req.body.Color,req.body.Size,req.body.Owner,req.body.AppraisedValue);
                var response = ({ "AssetId": req.body.ID })
        ...
        app.route('/update')
            .post((req: Request, res: Response) => {
                ...
                var response;
                try {
                Connection.contract.submitTransaction('UpdateAsset', req.body.ID,req.body.Color,req.body.Size,req.body.Owner,req.body.AppraisedValue); 
